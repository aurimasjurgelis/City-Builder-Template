...
public class GridStructure
{
	...
	public List<Vector3Int> GetStructuresPositionsInRange(Vector3Int gridPosition, int range)
	{
	...
	public bool ArePositionInRange(Vector3Int gridPosition, Vector3Int structurePositionNearby, int range)
	{
